          ...
          <ul className="nav navbar-nav navbar-right">
            <li className="dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                {props.dao_address &&
                  <li><Link to="/user/audit">аудитор</Link></li>
                }
                {props.dao_address &&
                  <li><Link to="/user/provider">поставщик</Link></li>
                }
                {props.dao_address &&
                  <li><Link to="/user/seller">продавец</Link></li>
                }
                {props.dao_address &&
                  <li><Link to="/user/buyer">покупатель</Link></li>
                }
              </ul>
            </li>
